...
public class AdocaoService {
    ...
    public void solicitar(SolicitacaoDeAdocaoDTO dto) {
        ...
        if (pet.getAdotado()) {
            throw new AdocaoException("'Pet já está adotado.'");
        }

        Boolean petAdotadoEmAndamento = adocaoRepository.existsByPetIdAndStatus(dto.idPet(), StatusAdocao.AGUARDANDO_AVALIACAO);

        if (petAdotadoEmAndamento) {
